    ...
    if selected_report_id != "-- Select a report --":
        ...
        if user_role in ['admin', 'approver']:
            ...
            if not original_expenses_df.empty:
                ...
                st.info("You can edit values directly in the table below. Click 'Save Changes' when done.")
                ...
                edited_expenses_df = st.data_editor(
                    expenses_to_edit,
                    column_config={
                        "id": None, "report_id": None, "user_id": None, "receipt_path": None, "ocr_text": None, "line_items": None, "created_at": None, "category_id": None,

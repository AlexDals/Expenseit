...
user_id_to_edit = st.session_state.get("user_id_to_edit")
if not user_id_to_edit:
    st.error("No user selected for editing. Please go back to User Management.")
    st.stop()
    ...
    if submitted:
        ...
        with st.spinner("Saving..."):
            if su.update_user_details(user_id_to_edit, new_role, approver_id, category_id):
                ...
                st.session_state.user_id_to_edit = None # Clear the state

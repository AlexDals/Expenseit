        ...
        if not original_expenses_df.empty:
            ...
            if available_columns_for_export:
                ...
                with btn_col2:
                    ...
                    st.download_button(label="📄 Download as Excel", data=excel_data, file_name=f"{clean_report_name}.xlsx", mime="application/vnd.openxmlformats-officedocument.sheet", use_container_width=True)
                with btn_col3:

...
if reports_df.empty:
    ...
    if selected_report_display_name != "-- Select a report --":
        ...
        if not original_expenses_df.empty:
            ...
            # --- FIX: The variable 'clean_report_name' was used before it was defined. ---
            # This line was missing. It's now restored.
            ...
            st.info("No expense items found for this report.")import streamlit as st
from utils import supabase_utils as su
import pandas as pd
import io
import re

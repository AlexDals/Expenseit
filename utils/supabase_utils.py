...
def generate_report_xml(report_data: pd.Series, expenses_data: pd.DataFrame, submitter_name: str) -> str:
    ...
    by including all placeholder fields and attributes.
    """
    ...
    record = ET.Element("Record", record_attrs)
    ...
    # Add attributes to every relevant tag
    ...
    create_sub_element(row_header, "ExchangeRate", "1", {"xmlns:dt": "urn:schemas-microsoft-com:datatypes", "dt:dt": "r8"})
    ...
    create_sub_element(row_header, "TaxHoldbackAmnt", "0", {"xmlns:dt": "urn:schemas-microsoft-com:datatypes", "dt:dt": "fixed.14.4"})
    create_sub_element(row_header, "TotAmnt", total_amount_str, {"xmlns:dt": "urn:schemas-microsoft-com:datatypes", "dt:dt": "fixed.14.4"})
    create_sub_element(row_header, "ShipAmnt", "0", {"xmlns:dt": "urn:schemas-microsoft-com:datatypes", "dt:dt": "fixed.14.4"})
    create_sub_element(row_header, "PurcType", "50", {"IsRawPrimaryKey": "-1"})
    create_sub_element(row_header, "SurchargeAmnt", "0", {"xmlns:dt": "urn:schemas-microsoft-com:datatypes", "dt:dt": "fixed.14.4"})

...
# The get_user_id_by_username function is no longer needed.

# ... (The rest of your utility functions from register_user onwards remain the same) ...
